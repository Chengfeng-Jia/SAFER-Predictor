...
def get_task(args, model, dm):
    task = getattr(tasks,args.settings.capitalize() + "ForecastTask")(args=args,model=model, feat_max_val=dm.feat_max_val, **vars(args))
    return task
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, help="The name of the dataset", choices=("shenzhen", "losloop","hk",'pem'), default="losloop"
    )
    parser.add_argument(
        "--model_name",
        type=str,
